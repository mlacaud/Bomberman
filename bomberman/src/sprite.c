...
#define BANNER_LEVEL            "sprite/flag.png"
...
// Sprites of Bombs
#define BOMB_TTL0	    "sprite/bomb0.png"
...
#define GOAL_PICTURE            "sprite/bomberwoman.png"


//congratulations of homer
SDL_Surface* homer;
...
void banner_load() {
	...
	banner_key = load_image(MAP_KEY);
	banner_level = load_image(BANNER_LEVEL);
...
void map_load() {
	...
	homer= load_image(HOMER);
	over=load_image(OVER);
	goal = load_image(GOAL_PICTURE);
}
